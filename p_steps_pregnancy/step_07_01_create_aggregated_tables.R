...
################################################################################
cat("12. Table Outline all years  \n ") 
...
if(D3_pregnancy_reconciled_valid_specific_year[, .N] > 0){
  cat("13. Table stream specific years  \n ")
  ...
  cat("14. Table quality specific years  \n ")
  ...
  cat("15. Table type/quality specific years  \n ")
  ...
  cat("16. Dummy table age by outcome specific years  \n ")
  ...
  cat("17. Dummy table ageband/outcome specific years  \n ")
  ...
  cat("18. Dummy table record number specific years  \n ")
  ...
  cat("19. Dummy table quality specific years  \n ")
  ...
  cat("20. Dummy tables meanings specific years  \n ")
  ...
  cat("21. Table reconciliation specific years  \n ")
  ##  Reconciliation 
  ...
  cat("22. Table Gestage at first record specific years  \n ")
  ## Median Age 
  ...
  cat("23. Table Gender specific years  \n ")
  ...
  ##################          Descriptive_pregnancies        #####################
  ################################################################################
  cat("24. Table Outline specific years  \n ") 
