...
if (TEST){
  ...
  # Directories test
  testname <- "05_05_test_adding_PROMPT_UNK"
...
if(PRP[, .N] > 0){ # n of subject with imputed month of birth
  ...
  DT_new_records <- rbindlist(list(PRP_1, PRP_2, PRP_3, PRP_4, PRP_5, PRP_6, PRP_7), fill=TRUE)
