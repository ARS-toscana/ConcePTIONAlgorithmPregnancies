...
year_start_descriptive_manuscript <- 2015
year_end_descriptive_manuscript <- 2019

D3_pregnancy_reconciled_valid_specific_year <- D3_pregnancy_reconciled_valid[ year_start_of_pregnancy >= year_start_descriptive_manuscript &
                                                                        year_start_of_pregnancy <= year_end_descriptive_manuscript]
...
fwrite(TableStream, paste0(direxpmanuscript, "TableStream_", year_start_descriptive_manuscript, "_", year_end_descriptive_manuscript, ".csv"))
...
fwrite(TableQuality, paste0(direxpmanuscript, "TableQuality_", year_start_descriptive_manuscript, "_", year_end_descriptive_manuscript, ".csv"))
...
fwrite(TableType, paste0(direxpmanuscript, "TableType_", year_start_descriptive_manuscript, "_", year_end_descriptive_manuscript, ".csv"))
...
fwrite(t_table_age_outcomes, paste0(direxpmanuscript, "TableAgeOutcomes_", year_start_descriptive_manuscript, "_", year_end_descriptive_manuscript, ".csv"))
...
fwrite(table_ageband, paste0(direxpmanuscript, "TableAgeband_", year_start_descriptive_manuscript, "_", year_end_descriptive_manuscript, ".csv"))
...
fwrite(t_table_records_outcomes, paste0(direxpmanuscript, "DTableRecords_", year_start_descriptive_manuscript, "_", year_end_descriptive_manuscript, ".csv"))
...
fwrite(t, paste0(direxpmanuscript, "DTableQuality_", year_start_descriptive_manuscript, "_", year_end_descriptive_manuscript, ".csv"))
...
fwrite(table_meaning_end, paste0(direxpmanuscript, "DTableMeaningEnd_", year_start_descriptive_manuscript, "_", year_end_descriptive_manuscript, ".csv"))
...
fwrite(table_meaning_start, paste0(direxpmanuscript, "DTableMeaningStart_", year_start_descriptive_manuscript, "_", year_end_descriptive_manuscript, ".csv"))
...
fwrite(TableGestage, paste0(direxpmanuscript, "TableGestage_", year_start_descriptive_manuscript, "_", year_end_descriptive_manuscript, ".csv"))
...
fwrite(TableGestageType, paste0(direxpmanuscript, "TableGestageType_", year_start_descriptive_manuscript, "_", year_end_descriptive_manuscript, ".csv"))
...
fwrite(TableGestageQuality, paste0(direxpmanuscript, "TableGestageQuality_", year_start_descriptive_manuscript, "_", year_end_descriptive_manuscript, ".csv"))
...
fwrite(TableGestageAggregated, paste0(direxpmanuscript, "TableGestageAggregated_", year_start_descriptive_manuscript, "_", year_end_descriptive_manuscript, ".csv"))
...
fwrite(TablePregSex, paste0(direxpmanuscript, "TablePregSex_", year_start_descriptive_manuscript, "_", year_end_descriptive_manuscript, ".csv"))
...
fwrite(Descriptive_pregnancies, paste0(direxpmanuscript, "Descriptive_pregnancies_", year_start_descriptive_manuscript, "_", year_end_descriptive_manuscript, ".csv"))
