...
if (this_datasource_has_itemsets_stream_from_medical_obs){ # this_datasource_has_medical_observations_prompt
  ...
  D3_excluded_pregnancies_from_ITEMSETS_1 <- D3_study_population_pregnancy1[pregnancy_with_dates_out_of_range==1,]
  ...
  D3_excluded_pregnancies_from_ITEMSETS_2 <- D3_study_population_pregnancy3[no_linked_to_person==1 | 
                                                                              person_not_in_fertile_age==1 | 
                                                                              record_date_not_in_spells == 1,] 
  
  D3_excluded_pregnancies_from_ITEMSETS<-rbind(D3_excluded_pregnancies_from_ITEMSETS_1,D3_excluded_pregnancies_from_ITEMSETS_2,fill=TRUE)
  D3_excluded_pregnancies_from_ITEMSETS <- D3_excluded_pregnancies_from_ITEMSETS[,-c( "sex_at_instance_creation",
                                                                                      "date_of_birth",
                                                                                      "date_death", 
  ...
  save(D3_excluded_pregnancies_from_ITEMSETS, file=paste0(dirtemp,"D3_excluded_pregnancies_from_ITEMSETS.RData")) 
  
  # pregnancies to be included in next steps
  D3_study_population_pregnancy_from_ITEMSETS<-D3_study_population_pregnancy3[no_linked_to_person==0 & 
                                                                                person_not_in_fertile_age==0 & 
                                                                                record_date_not_in_spells==0, ] 
  
  D3_study_population_pregnancy_from_ITEMSETS <- D3_study_population_pregnancy_from_ITEMSETS[,-c("no_linked_to_person",
                                                                                                 "person_not_in_fertile_age",
                                                                                                 "record_date_not_in_spells")]

  D3_Stream_ITEMSETS_check<-D3_study_population_pregnancy_from_ITEMSETS[,.(pregnancy_id,
                                                                           person_id,
                                                                           record_date,
  ...
  if(HTML_files_creation){
    cat("Describing D3_Stream_ITEMSETS_check \n")
  ...
  rm(D3_Stream_ITEMSETS,
     ...
     D3_excluded_pregnancies_from_ITEMSETS_1,
     D3_excluded_pregnancies_from_ITEMSETS_2,
