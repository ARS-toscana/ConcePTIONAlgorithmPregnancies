...
if (dim(D3_Stream_PROMPTS)[1]!=0){ 
  ...
  D3_Stream_PROMPTS_check<-D3_study_population_pregnancy_from_prompts[,.(pregnancy_id,person_id,record_date,pregnancy_start_date,pregnancy_end_date,meaning_start_date,meaning_end_date,type_of_pregnancy_end,imputed_start_of_pregnancy,imputed_end_of_pregnancy, column,meaning, origin,so_source_value,survey_id, visit_occurrence_id, PROMPT)]#
