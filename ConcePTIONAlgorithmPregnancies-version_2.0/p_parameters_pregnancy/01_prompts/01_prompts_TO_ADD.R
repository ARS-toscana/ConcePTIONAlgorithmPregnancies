...
meaning_of_survey_pregnancy[["TO_ADD"]][["livebirth_or_stillbirth"]]<-list("birth_registry_mother")
meaning_of_survey_pregnancy[["TO_ADD"]][["ongoing_pregnancy"]]<-list()
meaning_of_survey_pregnancy[["TO_ADD"]][["spontaneous_abortion"]]<-list("spontaneous_abortion_registry")
meaning_of_survey_pregnancy[["TO_ADD"]][["induced_termination"]]<-list("induced_termination_registry")
