...
itemset_AVpair_our_study[["GESTAGE_FROM_LMP_WEEKS"]][[files[i]]][["TO_ADD"]] <- list(list("CAP1","SETTAMEN_ARSNEW"), list("ABS","SETTAMEN_ARSNEW")) 
...
itemset_AVpair_our_study[["GESTAGE_FROM_USOUNDS_WEEKS"]][[files[i]]][["TO_ADD"]]  <- list(list("CAP1","GEST_ECO"))

# specification DATESTARTPREGNANCY
itemset_AVpair_our_study[["DATESTARTPREGNANCY"]][[files[i]]][["TO_ADD"]] <- list()


########################################## END ###################################################### 

itemset_AVpair_our_study[["DATEENDPREGNANCY"]][[files[i]]][["TO_ADD"]] <- list(list("CAP2","DATPARTO"))  
...
itemset_AVpair_our_study[["END_TERMINATION"]][[files[i]]][["TO_ADD"]] <- list(list("IVG","DATAINT"))

### specification END_ABORTION
itemset_AVpair_our_study[["END_ABORTION"]][[files[i]]][["TO_ADD"]] <- list(list("ABS","DATAINT"))


########################################### TYPE #######################################

itemset_AVpair_our_study[["TYPE"]][[files[i]]][["TO_ADD"]] <- list(list("CAP2", "VITALITA_TO_ADDNEW"))


################################ DICTINARY OF TYPE ##################################
dictonary_of_itemset <- vector(mode="list") 

dictonary_of_itemset[["TYPE"]][["TO_ADD"]][["LB"]]<-list(list("CAP2", "1"))
dictonary_of_itemset[["TYPE"]][["TO_ADD"]][["SB"]]<-list(list("CAP2", "2"))
dictonary_of_itemset[["TYPE"]][["TO_ADD"]][["SA"]]<-list()
dictonary_of_itemset[["TYPE"]][["TO_ADD"]][["T"]]<-list()
