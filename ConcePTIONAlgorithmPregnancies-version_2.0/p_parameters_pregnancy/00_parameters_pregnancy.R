...
datasource_with_itemsets_stream_from_medical_obs <- c("TO_ADD","GePaRD","BIFAP","VID") #@ use "TO_ADD" as example
...
datasource_with_prompt <- c("TO_ADD","ARS","PHARMO","UOSL","CASERTA","VID","CPRD","SNDS") #@ use "TO_ADD" as example
...
datasource_with_procedures <- c("TO_ADD","ARS","VID", "BIFAP", "CASERTA","SNDS") #@ use "TO_ADD" as example
