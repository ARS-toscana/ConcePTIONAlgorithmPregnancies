...
datasource_with_itemsets_stream_from_medical_obs <- c("TO_ADD","GePaRD","BIFAP","UOSL","VID") #@ use "TO_ADD" as example
...
datasource_with_prompt <- c("TO_ADD","ARS","PHARMO","UOSL","CASERTA","VID") #@ use "TO_ADD" as example
