...
concept_set_codes_pregnancy_datasource[["amniocentesis"]][["BIFAP"]][["TO_ADD_coding_system"]] <- c("75.10.2", "75.10.3")

####### Codes for Chorionic Villus Sampling ###############
concept_set_codes_pregnancy_datasource[["Chorionic_Villus_Sampling"]][["BIFAP"]][["TO_ADD_coding_system"]] <- c("75.10.1")

# ####### Codes for tests for others ###############
concept_set_codes_pregnancy_datasource[["others"]][["BIFAP"]][["TO_ADD_coding_system"]] <- c("75.34.1")
