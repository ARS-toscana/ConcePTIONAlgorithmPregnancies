...
meaning_of_survey_our_study[["ARS"]][["estimated_type_and_period_of_pregnancy"]]<-list()
...
meaning_of_survey_our_study[["UOSL"]][["estimated_type_and_period_of_pregnancy"]]<-list()
...
meaning_of_survey_our_study[["University_of_Aarhus"]][["estimated_type_and_period_of_pregnancy"]]<-list()
...
meaning_of_survey_our_study[["CHUT"]][["estimated_type_and_period_of_pregnancy"]]<-list()
...
meaning_of_survey_our_study[["BIPS"]][["estimated_type_and_period_of_pregnancy"]]<-list()
...
meaning_of_survey_our_study[["BIFAP"]][["estimated_type_and_period_of_pregnancy"]]<-list()

meaning_of_survey_our_study[["FISABIO"]][["livebirth_or_stillbirth"]]<-list("Birth_registry")
...
meaning_of_survey_our_study[["FISABIO"]][["estimated_type_and_period_of_pregnancy"]]<-list()
...
meaning_of_survey_our_study[["SIDIAP"]][["estimated_type_and_period_of_pregnancy"]]<-list()
...
meaning_of_survey_our_study[["UNIME"]][["estimated_type_and_period_of_pregnancy"]]<-list()
...
meaning_of_survey_our_study[["THL"]][["estimated_type_and_period_of_pregnancy"]]<-list()
...
meaning_of_survey_our_study[["CPRD"]][["estimated_type_and_period_of_pregnancy"]]<-list()
...
meaning_of_survey_our_study[["CNR-IFC"]][["estimated_type_and_period_of_pregnancy"]]<-list()
