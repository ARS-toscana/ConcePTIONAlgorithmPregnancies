...
item_set_codes_our_study[["gestational_diabetes"]][["ARS"]][["ITA_procedures_coding_system"]] <- c("90.26.7") #glucose tolerance test 60-120 minutes
...
item_set_codes_our_study[["amniocentesis"]][["ARS"]][["ITA_procedures_coding_system"]] <- c("75.10.2", "75.10.3")
...
####### Codes for Chorionic Villus Sampling ###############
 item_set_codes_our_study[["Chorionic_Villus_Sampling"]][["ARS"]][["ITA_procedures_coding_system"]] <- c("75.10.1")
# item_set_codes_our_study[["Chorionic_Villus_Sampling"]][["THL"]][[""]] <- c("MAA10")
 

# ####### Codes for tests for others ###############
item_set_codes_our_study[["others"]][["ARS"]][["ITA_procedures_coding_system"]] <- c("75.34.1")
