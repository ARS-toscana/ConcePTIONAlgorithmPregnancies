...
#item_set_codes_our_study[["gestational_diabetes"]][[""]] <- c("90.26.7") #glucose tolerance test 60-120 minutes
...
#item_set_codes_our_study[["amniocentesis"]][[""]] <- c("75.10.2", "75.10.3")
...
item_set_codes_our_study[["Chorionic_Villus_Sampling"]][[""]] <- c("75.10.1")
...
item_set_codes_our_study[["others"]][[""]] <- c("75.34.1")
