...
########################################## START ######################################################   
    ...
    # itemset_AVpair_our_study[["GESTAGE_FROM_DAPS_CRITERIA_WEEKS"]][[files[i]]][["FERR"]] <- list()
     itemset_AVpair_our_study[["GESTAGE_FROM_DAPS_CRITERIA_WEEKS"]][[files[i]]][["CNR-IFC"]]<- list(list("RTDC", "GESTLENGTH"))  
...
type_our_study[["ARS"]][["LB"]]<-list(list("CAP2", "1"))
type_our_study[["ARS"]][["SB"]]<-list(list("CAP2", "2"))
type_our_study[["ARS"]][["SA"]]<-list()
type_our_study[["ARS"]][["T"]]<-list()
type_our_study[["ARS"]][["MD"]]<-list()
type_our_study[["ARS"]][["UNK"]]<-list()

type_our_study[["UOSL"]][["LB"]]<-list(list("MBRN", "0"), list("MBRN", "1"), list("MBRN", "2"), list("MBRN", "3"), list("MBRN", "4"), list("MBRN", "5"), list("MBRN", "6"), list("MBRN", "11"), list("MBRN", "12"), list("MBRN", "13"))
type_our_study[["UOSL"]][["SB"]]<-list(list("MBRN", "7"), list("MBRN", "8"), list("MBRN", "9"))
type_our_study[["UOSL"]][["SA"]]<-list()
type_our_study[["UOSL"]][["T"]]<-list(list("MBRN", "10")) #?
type_our_study[["UOSL"]][["MD"]]<-list()
type_our_study[["UOSL"]][["UNK"]]<-list()

type_our_study[["CHUT"]][["LB"]]<-list(list("EFEMERIS_ISSUE", "1"))
type_our_study[["CHUT"]][["SB"]]<-list(list("EFEMERIS_INTERRUPTION", "MFIU"), list("EFEMERIS_INTERRUPTION", "MORT-NES"))
type_our_study[["CHUT"]][["SA"]]<-list(list("EFEMERIS_INTERRUPTION", "FCS"))
type_our_study[["CHUT"]][["T"]]<-list(list("EFEMERIS_INTERRUPTION", "IVG"), list("EFEMERIS_INTERRUPTION", "IMG"))
type_our_study[["CHUT"]][["MD"]]<-list()
type_our_study[["CHUT"]][["UNK"]]<-list(list("EFEMERIS_INTERRUPTION", "AUTRE"))

type_our_study[["BIPS"]][["LB"]]<-list(list("T_PREG", "1"), list("T_PREG", "2"), list("T_PREG", "3"))
type_our_study[["BIPS"]][["SB"]]<-list(list("T_PREG", "4"))
type_our_study[["BIPS"]][["SA"]]<-list(list("T_PREG", "7"))
type_our_study[["BIPS"]][["T"]]<-list(list("T_PREG", "5"))
type_our_study[["BIPS"]][["MD"]]<-list()
type_our_study[["BIPS"]][["UNK"]]<-list()

type_our_study[["BIFAP"]][["LB"]]<-list(list("EMB_BIFAP", "1"))
type_our_study[["BIFAP"]][["SB"]]<-list(list("EMB_BIFAP", "2"))
type_our_study[["BIFAP"]][["SA"]]<-list()
type_our_study[["BIFAP"]][["T"]]<-list(list("EMB_BIFAP", "3"))
type_our_study[["BIFAP"]][["MD"]]<-list()
type_our_study[["BIFAP"]][["UNK"]]<-list()

type_our_study[["FISABIO"]][["LB"]]<-list() #EUROmediCAT
type_our_study[["FISABIO"]][["SB"]]<-list()
type_our_study[["FISABIO"]][["SA"]]<-list()
type_our_study[["FISABIO"]][["T"]]<-list()
type_our_study[["FISABIO"]][["MD"]]<-list()
type_our_study[["FISABIO"]][["UNK"]]<-list()

type_our_study[["SIDIAP"]][["LB"]]<-list(list("Pregnancies", "P"), list("Pregnancies", "Pr"), list("Pregnancies", "C"), list("Pregnancies", "Al")) 
type_our_study[["SIDIAP"]][["SB"]]<-list()
type_our_study[["SIDIAP"]][["SA"]]<-list(list("Pregnancies", "MF"), list("Pregnancies", "A"))
type_our_study[["SIDIAP"]][["T"]]<-list(list("Pregnancies", "IV"))
type_our_study[["SIDIAP"]][["MD"]]<-list()
type_our_study[["SIDIAP"]][["UNK"]]<-list()

type_our_study[["CNR-IFC"]][["LB"]]<-list() # EUROmediCAT
type_our_study[["CNR-IFC"]][["SB"]]<-list()
type_our_study[["CNR-IFC"]][["SA"]]<-list()
type_our_study[["CNR-IFC"]][["T"]]<-list()
type_our_study[["CNR-IFC"]][["MD"]]<-list()
type_our_study[["CNR-IFC"]][["UNK"]]<-list()

type_our_study[["UNIME"]][["LB"]]<-list() # dubt
type_our_study[["UNIME"]][["SB"]]<-list()
type_our_study[["UNIME"]][["SA"]]<-list()
type_our_study[["UNIME"]][["T"]]<-list()
type_our_study[["UNIME"]][["MD"]]<-list()
type_our_study[["UNIME"]][["UNK"]]<-list()

type_our_study[["THL"]][["LB"]]<-list(list("SR_BASIC", "1"), list("SR_BASIC", "3"), list("ER_BASIC", "1"))
type_our_study[["THL"]][["SB"]]<-list(list("SR_BASIC", "2"), list("SR_BASIC", "4"), list("ER_BASIC", "2"))
type_our_study[["THL"]][["SA"]]<-list(list("ER_BASIC", "3"))
type_our_study[["THL"]][["T"]]<-list(list("ER_BASIC", "4"), list("ER_BASIC", "5"), list("ER_BASIC", "6"), list("ER_BASIC", "7"), list("ER_BASIC", "11"), list("ER_BASIC", "12"))
type_our_study[["THL"]][["MD"]]<-list()
type_our_study[["THL"]][["UNK"]]<-list(list("ER_BASIC", "99"))

type_our_study[["CPRD"]][["LB"]]<-list(list("PregnancyRegister", "1"))
type_our_study[["CPRD"]][["SB"]]<-list(list("PregnancyRegister", "2"))
type_our_study[["CPRD"]][["SA"]]<-list(list("PregnancyRegister", "4"))
type_our_study[["CPRD"]][["T"]]<-list(list("PregnancyRegister", "5"))
type_our_study[["CPRD"]][["MD"]]<-list()
type_our_study[["CPRD"]][["UNK"]]<-list(list("PregnancyRegister", "13"))
