...
if (this_datasource_has_itemsets_stream){
  ...
  if (thisdatasource=="ARS") {
    ...
    SPC_pregnancies<-SPC_pregnancies[meaning_of_visit=="first_encounter_for_ongoing_pregnancy", `:=`( pregnancy_start_date=record_date-60,pregnancy_ongoing_date=record_date,pregnancy_end_date=as.Date(NA), type_of_pregnancy_end="UNK", imputed_end_of_pregnancy=1, imputed_start_of_pregnancy=1, meaning_start_date="imputed_from_first_encounter_for_ongoing_pregnancy",meaning_ongoing_date="first_encounter_for_ongoing_pregnancy",meaning_end_date="unknown", ITEMSETS="Yes")]
    ##service_before_termination
    SPC_pregnancies<-SPC_pregnancies[meaning_of_visit=="service_before_termination", `:=`( pregnancy_start_date=record_date-70,pregnancy_ongoing_date=record_date,pregnancy_end_date=as.Date(NA), type_of_pregnancy_end="T", imputed_end_of_pregnancy=1, imputed_start_of_pregnancy=1, meaning_start_date="unknown",meaning_ongoing_date="service_before_termination",meaning_end_date="unknown", ITEMSETS="Yes")]
    ##service_for_ongoing_pregnancy
    SPC_pregnancies<-SPC_pregnancies[meaning_of_visit=="service_for_ongoing_pregnancy", `:=`(pregnancy_start_date=NA,pregnancy_ongoing_date=record_date,pregnancy_end_date=as.Date(NA), type_of_pregnancy_end="UNK", imputed_end_of_pregnancy=1, imputed_start_of_pregnancy=1, meaning_start_date="unknown",meaning_ongoing_date="first_encounter_for_ongoing_pregnancy",meaning_end_date="unknown", ITEMSETS="Yes")]
    ...
    D3_Stream_ITEMSETS <- SPC_pregnancies[,.(pregnancy_id,person_id,record_date,pregnancy_start_date,pregnancy_ongoing_date,pregnancy_end_date,meaning_start_date,meaning_end_date,meaning_ongoing_date,type_of_pregnancy_end,imputed_start_of_pregnancy,imputed_end_of_pregnancy,visit_occurrence_id,ITEMSETS,origin)]
    # 
