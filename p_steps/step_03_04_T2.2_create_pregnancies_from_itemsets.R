...
for (itemvar in item_sets_of_our_study){
...
for (itemvar in item_sets_of_our_study){
  ...
  dataset_item_sets <- rbind(dataset_item_sets,studyvardataset[,.(person_id,date,item_set,visit_occurrence_id)], fill=TRUE) 
}
...
dataset_item_sets<-dataset_item_sets[item_set%chin%dataset_item_sets, pregnancy_start_date:=date]
dataset_item_sets<-dataset_item_sets[item_set%chin%dataset_item_sets, pregnancy_ongoing_date:=date]
dataset_item_sets<-dataset_item_sets[item_set%chin%dataset_item_sets, pregnancy_end_date:=date]
