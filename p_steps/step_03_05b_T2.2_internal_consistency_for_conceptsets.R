...
D3_study_population_pregnancy1 <-D3_study_population_pregnancy1#[pregnancy_with_dates_out_of_range==0 & no_end_of_pregnancy==0,][,-c("pregnancy_with_dates_out_of_range","no_end_of_pregnancy")]
...
## put 154 days for stilbirth
cap<-unlist(meaning_of_survey_our_study_this_datasource[names(meaning_of_survey_our_study_this_datasource)=="birth_registry"])
D3_study_population_pregnancy4<-D3_study_population_pregnancy4[is.na(pregnancy_start_date) & meaning_end_date%in%cap & type_of_pregnancy_end=="stillbirth",`:=`(pregnancy_start_date=pregnancy_end_date-154, imputed_start_pregnancy=1)]
## put 259 days for livebirth
cap<-unlist(meaning_of_survey_our_study_this_datasource[names(meaning_of_survey_our_study_this_datasource)=="birth_registry"])
D3_study_population_pregnancy4<-D3_study_population_pregnancy4[is.na(pregnancy_start_date) & meaning_end_date%in%cap & type_of_pregnancy_end=="livebirth",`:=`(pregnancy_start_date=pregnancy_end_date-259, imputed_start_pregnancy=1)]
...
D3_Stream_CONCEPTSETS_check<-D3_study_population_pregnancy4
save(D3_Stream_CONCEPTSETS_check, file=paste0(dirtemp,"D3_Stream_CONCEPTSETS_check.RData"))

rm(D3_Stream_CONCEPTSETS,D3_study_population_pregnancy1,D3_study_population_pregnancy2, D3_study_population_pregnancy3, D3_study_population_pregnancy4,D3_Stream_CONCEPTSETS_check)
######################################################################################
## import D3_Stream_EUROCAT
load(paste0(dirtemp,"D3_Stream_EUROCAT.RData"))
