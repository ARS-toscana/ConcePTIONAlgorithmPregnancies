...
load(paste0(dirtemp,"D3_study_population_pregnancy_intermediate_from_prompt.RData"))



## define quality vars in D3_study_population_pregnancy_intermediate_from_prompt
D3_study_population_pregnancy1<- D3_study_population_pregnancy_intermediate_from_prompt[pregnancy_end_date<date_start_min | year(pregnancy_end_date)>2021, pregnancy_with_dates_out_of_range:=1][is.na(pregnancy_with_dates_out_of_range),pregnancy_with_dates_out_of_range:=0]
...
rm(D3_PERSONS, output_spells_category, D3_study_population_pregnancy1, D3_study_population_pregnancy2, D3_study_population_pregnancy3, D3_study_population_pregnancy4, D3_study_population_pregnancy_intermediate_from_prompt,D3_Stream_PROMPTS)
