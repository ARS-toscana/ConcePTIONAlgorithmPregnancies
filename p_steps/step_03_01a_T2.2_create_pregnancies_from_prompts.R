...
D3_study_population_pregnancy_intermediate<- D3_study_population_pregnancy_intermediate[pregnancy_end_date<date_start_min, pregnancy_with_dates_out_of_range:=1][is.na(pregnancy_with_dates_out_of_range),pregnancy_with_dates_out_of_range:=0]
table(D3_study_population_pregnancy_intermediate$pregnancy_with_dates_out_of_range) # 18 deleted
...
table(D3_study_population_pregnancy$no_link_to_person) # 208053 deleted
# no female
...
table(D3_study_population_pregnancy$no_female) # 234631 deleted
...
table(D3_study_population_pregnancy$no_fertile_age) # 454296 deleted
...
save(D3_excluded_pregnancies_from_prompts, file=paste0(dirtemp,"D3_excluded_pregnancies_from_prompts.RData"))


# pregnancies to be included in netx steps
D3_study_population_pregnancy_from_prompts<-D3_study_population_pregnancy[no_link_to_person==0 & no_female==0 & no_fertile_age==0,]
