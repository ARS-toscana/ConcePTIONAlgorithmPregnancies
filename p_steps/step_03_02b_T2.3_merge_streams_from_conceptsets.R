...
load(paste0(dirtemp,"D3_study_population_pregnancy_intermediate_from_conceptsets.RData"))
...
D3_Stream_CONCEPTSETS<-D3_study_population_pregnancy4
save(D3_Stream_CONCEPTSETS, file=paste0(dirtemp,"D3_Stream_CONCEPTSETS.RData"))



rm(D3_PERSONS, output_spells_category, D3_study_population_pregnancy1, D3_study_population_pregnancy2, D3_study_population_pregnancy3, D3_study_population_pregnancy4, D3_study_population_pregnancy_intermediate_from_prompt,D3_Stream_CONCEPTSETS)
