...
coding_system_in_concept_sets<-names(concept_set_codes_pregnancy[[concept_set_prova]])

if(sum(allcodes_inMETADATA_nofree  %notin% coding_system_in_concept_sets)*1 >0) {
  warning(c("There is an error in coding system: one or more coding system in your data are not included in the list of coding systems supported by this script.","Please contact the script programmer."))
