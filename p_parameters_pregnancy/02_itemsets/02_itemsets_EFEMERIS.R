...
itemset_AVpair_pregnancy[["DATESTARTPREGNANCY"]][[files[i]]][["EFEMERIS"]] <- list(list("EFEMERIS_ISSUE","deb_grossesse"))


########################################## END ###################################################### 

itemset_AVpair_pregnancy[["DATEENDPREGNANCY"]][[files[i]]][["EFEMERIS"]] <- list(list("EFEMERIS_ISSUE","DATE_ACC"))  
...
itemset_AVpair_pregnancy[["TYPE"]][[files[i]]][["EFEMERIS"]] <- list(list("EFEMERIS_ISSUE", "ISSUE"),list("EFEMERIS_INTERRUPTION", "ISSUE"))
