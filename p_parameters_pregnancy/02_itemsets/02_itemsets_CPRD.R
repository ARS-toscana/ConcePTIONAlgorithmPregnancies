...
dictonary_of_itemset_pregnancy[["TYPE"]][["CPRD"]][["LB"]]<-list(list("pregnancy_register", "3"))
dictonary_of_itemset_pregnancy[["TYPE"]][["CPRD"]][["SA"]]<-list(list("pregnancy_register", "4"))
dictonary_of_itemset_pregnancy[["TYPE"]][["CPRD"]][["T"]]<-list(list("pregnancy_register", "5"),list("pregnancy_register", "6"))
...
dictonary_of_itemset_pregnancy[["TYPE"]][["CPRD"]][["UNF"]]<-list(list("pregnancy_register", "8"), list("pregnancy_register", "9"), list("pregnancy_register", "10"))                                                       
dictonary_of_itemset_pregnancy[["TYPE"]][["CPRD"]][["UNK"]]<-list(                                                                  list("pregnancy_register", "11"), list("pregnancy_register", "12"), list("pregnancy_register", "13"))
