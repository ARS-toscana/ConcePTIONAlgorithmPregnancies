...
# 4. datasource with VISIT_OCCURRENCE prompt
...
# 8. datasource with person rel table
...
# 9. datasource with prompt with child person_id
...
# 10. datasource with related_id corresponding to child
