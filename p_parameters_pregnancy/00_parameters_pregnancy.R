...
datasource_with_prompt <- c("TO_ADD","TEST","ARS","PHARMO","UOSL","CASERTA","VID","CPRD","GePaRD","EpiChron","SIDIAP","SAIL Databank","EFEMERIS", "POMME",  "DANREG" ,"KI", "THL", "FERR") #@ use "TO_ADD" as example
...
datasource_with_person_rel_table <- c("EFEMERIS", "POMME",  "THL", "ARS", "FERR", "UOSL", "SAIL Databank") #@ use "TO_ADD" as example
...
datasource_with_prompt_child <- c("EFEMERIS", "POMME",  "THL") #@ use "TO_ADD" as example
