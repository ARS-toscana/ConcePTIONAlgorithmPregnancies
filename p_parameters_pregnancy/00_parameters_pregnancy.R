...
datasource_with_visit_occurrence_prompt <- c("TO_ADD","TEST","EpiChron") 
...
datasource_with_procedures <- c("TO_ADD","TEST","VID", "BIFAP", "CASERTA","SNDS","GePaRD","EpiChron","HSD", "PHARMO", "ATS") 
