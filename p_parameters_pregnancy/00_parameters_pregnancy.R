...
datasource_with_person_rel_table <- c("EFEMERIS", "POMME",  "THL", "ARS", "FERR", "UOSL", "SAIL Databank", "RDRU_FISABIO") #@ use "TO_ADD" as example
...
datasources_that_do_not_use_prediction_on_red <- c("EFEMERIS", "POMME", "THL", "RDRU_FISABIO")
