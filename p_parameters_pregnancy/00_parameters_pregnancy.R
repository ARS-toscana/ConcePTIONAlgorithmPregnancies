...
datasources_EUROCAT <- c("TO_ADD","SAIL Databank", "VID", "ATS") #@ use "TO_ADD" as example
...
datasource_with_prompt <- c("TO_ADD","TEST","ARS","PHARMO","UOSL","VID","CPRD","GePaRD","EpiChron","SIDIAP","SAIL Databank","EFEMERIS", "POMME",  "DANREG" ,"KI", "THL", "FERR", "RDRU_FISABIO", "CASERTA", "ATS") #@ use "TO_ADD" as example
...
datasource_with_procedures <- c("TO_ADD","TEST","ARS","VID", "BIFAP", "CASERTA","SNDS","GePaRD","EpiChron","HSD", "PHARMO", "ATS") #@ use "TO_ADD" as example # check new concepeset
...
datasource_with_person_rel_table <- c("EFEMERIS", "POMME",  "THL", "ARS", "FERR", "UOSL", "SAIL Databank", "RDRU_FISABIO", "DANREG", "VID", "SIDIAP","SNDS", "ATS") #@ use "TO_ADD" as example
