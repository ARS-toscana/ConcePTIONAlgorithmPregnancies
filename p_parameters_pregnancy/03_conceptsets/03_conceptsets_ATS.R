...
####### LOAD PROCEDURES for ATS nuova versione: ITA_procedures_coding_system ICD9PROC, gli icd9 non ci sono , perchè gli altri li hanno messi?

####### Codes for tests for gestational diabetes ###############
#ITA_procedures_coding_system  non distinguiamo  
# concept_set_codes_pregnancy_datasource[["gestational_diabetes"]][["ATS"]][["ICD9CM"]] <- c("64880","64881","64882","64883","64884")
...
concept_set_codes_pregnancy_datasource[["amniocentesis"]][["ATS"]][["ICD9PROC"]] <- c("751", "7531", "7537")
...
concept_set_codes_pregnancy_datasource[["Chorionic_Villus_Sampling"]][["ATS"]][["ICD9PROC"]] <- c("7533") #ICD-9-MC (is also captured in "others")
#75.33 Fetal blood sampling and biopsy

# ####### Codes for tests for others ############### DA SISTEMARE CODICI SOTTO
concept_set_codes_pregnancy_datasource[["others"]][["ATS"]][["ITA_procedures_coding_system"]] <- c("8878", "90431")
concept_set_codes_pregnancy_datasource[["others"]][["ATS"]][["Italian code system for exemptions"]] <- c("M50","M20","M30","M36","M12","M41","M08","M07","M00","M99","M35","M38","M24","M06","M10","M28","M09","M32","M37","M16","M31","M21","M14","M25","M13","M15","M34","M40","M26","M33","M11","M18","M19","M22","M29","M17","M23","M27","M05","M60","M39","M04","M01","M03","M02","M52")
...
#concept_set_codes_pregnancy_datasource[["others"]][["ATS"]][["ICD9CM"]] <- c("66970") #ICD-9-MC (is also captured in "others")
...
##concept_set_codes_pregnancy_datasource[["others"]][["ATS"]][["ITA_procedures_coding_system"]] <- c()
