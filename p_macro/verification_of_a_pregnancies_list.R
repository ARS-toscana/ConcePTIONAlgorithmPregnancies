...
original_sample <- D3_pregnancy_reconciled_valid[pregnancy_id %in% list_of_pregnancy_id_to_be_retrieved]
...
save(original_sample, file = paste0(diradditionalverif, "/original_sample", now, ".RData"))
...
save(sample_from_pregnancies, file=paste0(diradditionalverif,"/sample_from_pregnancies", now, ".RData"))

### delete id and sort 
sample_from_pregnancies_anon <- sample_from_pregnancies[, pregnancy_id := preg_id ]
sample_from_pregnancies_anon <- sample_from_pregnancies[, original_pregnancy_id := preg_id ]
...
fwrite(DT_time, paste0(diradditionalverif, "/DT_time.csv"))
fwrite(sample_from_pregnancies_anon, paste0(diradditionalverif, "/sample_from_pregnancies_", now, ".csv"))
