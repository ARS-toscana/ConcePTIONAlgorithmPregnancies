...
DT_start <- DT_start[tolower(pregnancy_start_date_correct) == "unk_not_ass", pregnancy_start_date_difference := "6. UNK ASSESSABLE"]
DT_start <- DT_start[tolower(pregnancy_start_date_correct) == "unk_not_asse", pregnancy_start_date_difference := "7. UNK NOT ASSESSABLE"]
...
DT_end <- DT_end[tolower(pregnancy_end_date_correct) == "unk_not_ass", pregnancy_end_date_difference := "7. UNK NOT ASSESSABLE"]
