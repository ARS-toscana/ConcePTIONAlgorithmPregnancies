...
`r number_of_pregnancies_with_child ` pregnancies were linked to offsprings. Among these `r number_of_pregnancies_with_one_child` have 1 child, `r number_of_pregnancies_with_more_than_one_child` have more than one. `r n_of_child_with_more_than_one_mother` children have more than one mother.

 The following graph shows the absolute number of live birth pregnancies linked to the respective number of children, anchored by the year of start of pregnancy.
