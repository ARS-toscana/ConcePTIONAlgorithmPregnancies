...
D3_mother_child_ids_plt_year <- merge(D3_pregnancy_reconciled[, .(pregnancy_id, year = year(pregnancy_start_date))],
...
Of these pregnancies `r number_of_pregnancies_with_child ` were linked to offsprings. Among these `r number_of_pregnancies_with_one_child` have 1 child, `r number_of_pregnancies_with_more_than_one_child` have more than one.

 The following graph shows the absolute number of pregnancies linked to the respective number of children, anchored by the year of start of pregnancy.
